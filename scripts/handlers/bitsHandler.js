...
(function() {
	var toggle = $.getSetIniDbBoolean('bitsSettings', 'toggle', false),
	    message = $.getSetIniDbString('bitsSettings', 'message', '(name) hat dir (amount) Bits spendiert!'),
	...
	function reloadBits() {
	    ...
	    message = $.getIniDbString('bitsSettings', 'message', '(name) hat dir (amount) Bits spendiert!');
