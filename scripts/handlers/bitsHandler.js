...
(function() {
	var toggle = $.getSetIniDbBoolean('bitsSettings', 'toggle', false),
	    message = $.getSetIniDbString('bitsSettings', 'message', '(name) hat dir eben mit (amount) Bits zugejubelt!'),
	...
	function reloadBits() {
	    ...
	    message = $.getIniDbString('bitsSettings', 'message', '(name) hat dir eben mit (amount) Bits zugejubelt!');
