...
(function() {
    ...
    function buildEmotesDB(bttvEmotes, bttvLocalEmotes, ffzEmotes, ffzLocalEmotes) {
        ...
        loaded = true;
        $.consoleDebug("Erstelle " + emotesRegExpList.length + " reguläre Ausdrücke für Emotes Handhabung.");
    }
    ...
    function loadEmoteCache() {
        ...
        loaded = true;
        $.consoleDebug("Erstelle " + emotesRegExpList.length + " reguläre Ausdrücke für Emotes Handhabung aus Zwischenspeicher.");
    }
