...
(function() {
    ...
    function readFile(path) {
        ...
        try {
            ...
            $.log.error('Öffnen von \'' + path + '\' fehlgeschlagen: ' + e);
        }
        return lines;
    };
    ...
    function moveFile(file, path) {
        ...
        if ((fileO != null && pathO != null) || (file != "" && path != "")) {
            try {
                ...
                $.log.error("Verschieben von (" + file + ", " + path + ") fehlgeschlagen: " + ex);
            }
        }
    };
    ...
    function touchFile(path) {
        try {
            ...
            $.log.error('Erstellen von \'' + path + '\' fehlgeschlagen: ' + e);
        }
    };
    ...
    function deleteFile(path, now) {
        try {
            ...
            $.log.error('Löschen von \'' + path + '\' fehlgeschlagen: ' + e);
        }
    };
    ...
    function findFiles(directory, pattern) {
        try {
            ...
            $.log.error('Suche in \'' + directory + '\' fehlgeschlagen: ' + e);
        }
        return [];
    };
