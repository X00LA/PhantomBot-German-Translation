(function() {
    var permitList = [],
        ...
        silentTimeout = {
            ...
            LinkMessage: $.getSetIniDbString('chatModerator', 'silentLinkMessage', 'Links ohne Berechtigung posten. (Automatisiert von ' + $.botName + ')'),
            SpamMessage: $.getSetIniDbString('chatModerator', 'silentSpamMessage', 'Exessives verwenden von sich wiederholenden Zeichen. (Automatisiert von ' + $.botName + ')'),
            CapMessage: $.getSetIniDbString('chatModerator', 'silentCapMessage', 'Exessives verwenden von Großbuchstaben. (Automatisiert von ' + $.botName + ')'),
            SymbolMessage: $.getSetIniDbString('chatModerator', 'silentSymbolsMessage', 'Exessives verwenden von Symbolen. (Automatisiert von ' + $.botName + ')'),
            ColorMessage: $.getSetIniDbString('chatModerator', 'silentColorMessage', 'Verwenden farbigen Textes (/me). (Automatisiert von ' + $.botName + ')'),
            EmoteMessage: $.getSetIniDbString('chatModerator', 'silentEmoteMessage', 'Exessives verwenden von Emotes. (Automatisiert von ' + $.botName + ')'),
