...
(function() {
	var toggle = $.getSetIniDbBoolean('discordSettings', 'tipeeestreamToggle', false),
	    message = $.getSetIniDbString('discordSettings', 'tipeeestreamMessage', 'Vielen Dank (name), für die Spende von (formattedamount) (currency)!'),
    ...
    $.bind('panelWebSocket', function(event) {
        if (event.getScript().equalsIgnoreCase('./discord/handlers/tipeeeStreamHandler.js')) {
            ...
            message = $.getIniDbString('discordSettings', 'tipeeestreamMessage', 'Vielen Dank (name), für die Spende von €(formattedamount) (currency)!');
