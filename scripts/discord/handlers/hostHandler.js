...
(function() {
    var toggle = $.getSetIniDbBoolean('discordSettings', 'hostToggle', false),
        hostMessage = $.getSetIniDbString('discordSettings', 'hostMessage', '(name) hosted dich jetzt!'),
        autoHostMessage = $.getSetIniDbString('discordSettings', 'autohostMessage', '(name) autohostet dich jetzt!'),
    ...
    $.bind('webPanelSocketUpdate', function(event) {
        if (event.getScript().equalsIgnoreCase('./discord/handlers/hostHandler.js')) {
            ...
            hostMessage = $.getIniDbString('discordSettings', 'hostMessage', '(name) hostet dich jetzt!');
            autoHostMessage = $.getIniDbString('discordSettings', 'autohostMessage', '(name) auto-hosted dich jetzt!');
