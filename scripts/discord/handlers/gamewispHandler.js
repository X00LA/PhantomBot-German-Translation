 ...
 */
(function() {
    var subMessage = $.getSetIniDbString('discordSettings', 'gamewispSubMessage', '(name) hat dich gerade auf GameWisp mit dem Rang (tier) abonniert!'),
        resubMessage = $.getSetIniDbString('discordSettings', 'gamewispReSubMessage', '(name) hat dich seit (months) Monaten in Folge via GameWisp abonniert!'),
        tierMessage = $.getSetIniDbString('discordSettings', 'gamewispTierMessage', '(name) hat seinen Rang auf (tier) hochgestuft!'),
    ...
    $.bind('panelWebSocket', function(event) {
        if (event.getScript().equalsIgnoreCase('./discord/handlers/gamewispHandler.js')) {
            subMessage = $.getIniDbString('discordSettings', 'gamewispSubMessage', '(name) hat dich gerade auf GameWisp mit dem Rang (tier) abonniert!');
            resubMessage = $.getIniDbString('discordSettings', 'gamewispReSubMessage', '(name) hat dich seit (months) Monaten in Folge via GameWisp abonniert!');
            tierMessage = $.getIniDbString('discordSettings', 'gamewispTierMessage', '(name) hat seinen Rang auf (tier) hochgestuft!');
