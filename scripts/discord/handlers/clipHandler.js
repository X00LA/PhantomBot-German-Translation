...
(function() {
    var toggle = $.getSetIniDbBoolean('discordSettings', 'clipsToggle', false),
        message = $.getSetIniDbString('discordSettings', 'clipsMessage', '(name) hat einen Clip erstellt: (url)'),
    ...
    $.bind('webPanelSocketUpdate', function(event) {
        if (event.getScript().equalsIgnoreCase('./discord/handlers/clipHandler.js')) {
            ...
            message = $.getIniDbString('discordSettings', 'clipsMessage', '(name) hat einen Clip erstellt: (url)');
