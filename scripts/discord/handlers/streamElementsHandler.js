...
(function() {
    var toggle = $.getSetIniDbBoolean('discordSettings', 'streamelementsToggle', false),
        message = $.getSetIniDbString('discordSettings', 'streamelementsMessage', 'Vielen Dank (name) für deine Spende von (formattedamount) (currency)!'),
    ...
    $.bind('webPanelSocketUpdate', function(event) {
        if (event.getScript().equalsIgnoreCase('./discord/handlers/streamElementsHandler.js')) {
            ...
            message = $.getIniDbString('discordSettings', 'streamelementsMessage', 'Vielen Dank (name) für deine Spende von (formattedamount) (currency)!');
