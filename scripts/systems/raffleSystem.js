(function() {
    var cost = 0,
        ...
        raffleMessage = $.getSetIniDbString('settings', 'raffleMessage', 'Eine Verlosung ist noch geöffnet! Tippe !(keyword) um mitzumachen. (entries) Benutzer machen bisher mit.'),
