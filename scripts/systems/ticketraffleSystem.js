(function() {
    var cost = 0,
        ...
        raffleMessage = $.getSetIniDbString('settings', 'traffleMessage', 'Eine Verlosung ist bereits geöffnet! Tippe !tickets (Anzahl) um mitzumachen. (entries) Benutzer machen bisher mit.'),
