(function() {
    var cost = 0,
        ...
        raffleMessage = $.getSetIniDbString('settings', 'traffleMessage', 'Eine Verlosung ist bereits im Gange! Tippe !tickets (Anzahl) um mitzumachen. (entries) BenutzerInnen nehmen bereits Teil.'),
