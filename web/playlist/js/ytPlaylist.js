...
connection.onmessage = function(e) {
    ...
    if (messageObject['authresult'] === false) {
        if (!messageObject['authresult']) {
            newAlert('WS Authentifikation fehlgeschlagen!', 'Lade die Seite neu und wenn das nichts hilft, lass es bitte den Streamer wissen.', 'danger', 0);
            return;
        }
        return;
    }
...
function handlePlayList(d) {
    ...
    var tableData = '<tr><th>Song Titel</th><th>Dauer</th><th>YouTube ID</th></tr>';
