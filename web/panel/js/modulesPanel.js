...
(function() {
                ...
                for (idx in msgObject['results']) {
                    ...
                    if (module.indexOf('/core/') === -1 && module.indexOf('/lang/') === -1) {
                        ...
                        html += "<tr><td><div id=\"moduleStatus_" + idx + "\" class=\"textList\" style=\"padding: 2px\">" + pill + "</div></td>" +
                                ...
                                "<td><button type=\"button\" class=\"btn btn-danger btn-xs pull-right\" onclick=\"$.disableModule('" + module + "', " + idx + ")\">Deaktivieren</button>" +
                                "<button type=\"button\" class=\"btn btn-success btn-xs pull-right\" onclick=\"$.enableModule('" + module + "', " + idx + ")\">Aktivieren</button></td>" +
                                "</tr>";
                    }
                }
                html += "</table>";
    ...
    setInterval(function() {
        var active = $("#tabs").tabs("option", "active");
        if (active == 1 && isConnected) {
            newPanelAlert('Aktualisiere Module-Daten...', 'success', 1000);
            doQuery();
        }
    }, 3e4);
