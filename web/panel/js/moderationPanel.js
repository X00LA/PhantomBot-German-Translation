...
(function() {
    ...
    var modSettingMap = [];
        ...
        modSettingMap['subscribersModerateSymbols'] = "Abonnent " + modSettingMap['symbolsToggle'];
        modSettingMap['subscribersModerateSpam'] = "Abonnent " +  modSettingMap['spamToggle'];
        modSettingMap['subscribersModerateEmotes'] = "Abonnent " + modSettingMap['emotesToggle'];
        ...
        modSettingMap['regularsModerateSymbols'] = "Stammzuschauer " + modSettingMap['symbolsToggle'];
        modSettingMap['regularsModerateSpam'] = "Stammzuschauer " + modSettingMap['spamToggle'];
    ...
    function addModBlacklist(clear) {
        ...
        $("#blackList_message").val('Du hast dir, für die Verwendung eines Wortes aus der schwarzen Liste, eine Auszeit verdient!');
        $("#blacklistReason").val('Verwendung eines gelisteten Wortes.');
    ...
    function addModWhitelist() {
        ...
        if (value.length > 0) {
            ...
            $("#addModWhitelistInput").val("Übermittelt");
    ...
    function quickSetModeration(type, disableSubs, disableRegs, disableViewers) {
        ...
        $("#quickModerationUpdate").html("<br><span class=\"purplePill\">&nbsp;Bitte warten, Einstellungen werden aktualisiert...&nbsp;</span>");
        setTimeout(function() { doQuery(); }, TIMEOUT_WAIT_TIME);
    ...
    function permitUserCommand() {
        ...
        $("#permitUserInput").val("Übermittelt");
    ...
    setInterval(function() {
        ...
        if (active == 2 && isConnected && !isInputFocus()) {
            newPanelAlert('Aktualisiere Moderations-Daten...', 'success', 1000);
            doQuery();
        }
    }, 3e4);
